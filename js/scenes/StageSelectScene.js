...
class StageSelectScene {
  constructor(sceneManager, player) {
    ...
    this.WORLD_STORIES = {};
    this.WORLD_STORIES[1] = "かつて平和だった王国に、魔物の脅威が迫っている。\n勇者よ、旅立ちの時だ。";
    this.WORLD_STORIES[2] = "海岸に打ち上げられた古代の遺物。\n海の底から異形の者たちが現れ始めた。";
    this.WORLD_STORIES[3] = "深い森の奥、エルフたちの結界が崩れ始めている。\n森に潜む闇を払え。";
    this.WORLD_STORIES[4] = "灼熱の火山地帯。炎の精霊たちが暴走を始めた。\n地の底から甦る古の炎帝を止めろ。";
    this.WORLD_STORIES[5] = "永久凍土に閉ざされた氷の大地。\n千年の眠りから覚めた氷姫が世界を凍てつかせる。";
    this.WORLD_STORIES[6] = "果てなき砂漠に眠る古代王朝の遺跡。\n砂に封じられた王の呪いが解き放たれた。";
    this.WORLD_STORIES[7] = "闇に包まれた暗黒城。かつての英雄が闇に堕ちた。\n彼を止められるのはお前だけだ。";
    this.WORLD_STORIES[8] = "雲の上の天空城。天使たちが人間を裁こうとしている。\n神の試練を乗り越えよ。";
    this.WORLD_STORIES[9] = "魔界の門が開かれた。魔王の軍勢が押し寄せる。\nこれが最後の戦いだ。";
    this.WORLD_STORIES[10] = "世界の終焉。全てを飲み込む虚無が迫る。\n神装の力で、終焉の神を討て。";
  }
