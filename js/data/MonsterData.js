...
var MonsterData = {
  ...
  SLIMES: [
    ...
    { grade:7, id:'sl7', name:'ブラックゼリー',   race:'slime', hp:2000, atk:140, matk:100, def:65,  mdef:60, spd:45, exp:220, gold:70,  color:'#223333', eye:'glow' },
    { grade:8, id:'sl8', name:'スライムキング',   race:'slime', hp:4000, atk:220, matk:160, def:90,  mdef:85, spd:35, exp:400, gold:120, color:'#aa1122', eye:'king', crown:true, flame:true },
  ],
  ...
  BEASTS: [
    ...
    { grade:7, id:'bt7', name:'グリフォンレッサ', race:'beast', hp:2200, atk:160, matk:60, def:55,  mdef:50, spd:55, exp:240, gold:75,  color:'#cc9933', shape:'griffon' },
    { grade:8, id:'bt8', name:'キマイラ',       race:'beast', hp:5000, atk:250, matk:180, def:100, mdef:90, spd:45, exp:440, gold:140, color:'#885522', shape:'chimera' },
  ],
  ...
  DRAGONS: [
    ...
    { grade:7, id:'dr7', name:'エインシャントドラゴン', race:'dragon', hp:2800, atk:180, matk:130, def:75, mdef:70, spd:42, exp:280, gold:85, color:'#336644', shape:'ancient' },
    { grade:8, id:'dr8', name:'アビス・ドラゴン', race:'dragon', hp:6000, atk:280, matk:200, def:110, mdef:100, spd:48, exp:500, gold:160, color:'#442266', shape:'abyss', aura:true },
  ],
  ...
  BANDITS: [
    ...
    { grade:7, id:'bd7', name:'賊の魔道士',     race:'bandit', hp:2100, atk:100, matk:140, def:45,  mdef:65, spd:42, exp:260, gold:80,  color:'#553366', shape:'mage' },
    { grade:8, id:'bd8', name:'盗賊王',         race:'bandit', hp:4500, atk:240, matk:120, def:95,  mdef:80, spd:50, exp:460, gold:150, color:'#dddddd', shape:'king' },
  ],
